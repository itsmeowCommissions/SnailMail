...
public class SnailBoxListWidget extends ExtendedList<SnailBoxListWidget.BoxEntry> {
    ...
    public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
        ...
        AbstractGui.fill(x0 - 6, parent.height - 30, x0 + 256 + 6, parent.height, 0xFF606060);
        AbstractGui.fill(x0 - 6, parent.height - 30, x0 + 256 + 6, parent.height - 29, 0xFF000000);
    }
    ...
    public class BoxEntry extends ExtendedList.AbstractListEntry<BoxEntry> {
        ...
        public void render(int entryIdx, int top, int left, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean p_194999_5_, float partialTicks) {
            ...
            font.drawString(font.trimStringToWidth(box.name, 256), left + 3, top + 2, 0xFFFFFF);
            String locString = "";
            if(box.pos != null) {
