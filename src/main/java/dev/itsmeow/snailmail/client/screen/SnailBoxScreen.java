...
public class SnailBoxScreen extends ContainerScreen<SnailBoxContainer> implements IEnvelopePacketReceiver {
    ...
    protected void init() {
        ...
        this.nameField = new TextFieldWidget(this.font, xStart + 111, yStart + 84, 58, 10, I18n.format("container.snailmail.snail_box.textfield.name")) {
        ...
        this.nameField.setResponder(newText -> {
            SnailMail.HANDLER.sendToServer(new SetSnailBoxNamePacket(newText));
