...
public class SnailBoxMemberListWidget extends ExtendedList<SnailBoxMemberListWidget.MemberEntry> {
    ...
    public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
        ...
        AbstractGui.fill(x0 - 6, parent.height - 55, x0 + 256 + 6, parent.height, 0xFF606060);
        AbstractGui.fill(x0 - 6, parent.height - 55, x0 + 256 + 6, parent.height - 54, 0xFF000000);
        AbstractGui.fill(x0 - 6, 0, x0 + 256 + 6, 24, 0xFF606060);
        AbstractGui.fill(x0 - 6, 25, x0 + 256 + 6, 25, 0xFF000000);
    }

    @Override
    protected void renderBackground() {
        parent.renderBackground();
        AbstractGui.fill(x0 - 6, 0, x0 + 256 + 6, parent.height, 0xFF404040);
        AbstractGui.fill(x0 - 7, 0, x0 - 6, parent.height, 0xFF000000);
        AbstractGui.fill(x0 + 256 + 6, 0, x0 + 256 + 7, parent.height, 0xFF000000);
    }
    ...
    public class MemberEntry extends ExtendedList.AbstractListEntry<MemberEntry> {
        ...
        public void render(int entryIdx, int top, int left, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean p_194999_5_, float partialTicks) {
            AbstractGui.fill(left, top, left + entryWidth - 4, top + entryHeight, 0xFF303030);
            FontRenderer font = SnailBoxMemberListWidget.this.parent.getFontRenderer();
            font.drawString(font.trimStringToWidth(nameOrId, 256), left + 3, top + 2, 0xFFFFFF);
        }
