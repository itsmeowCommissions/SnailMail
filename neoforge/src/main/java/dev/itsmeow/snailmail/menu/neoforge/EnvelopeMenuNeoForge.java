...
import dev.itsmeow.snailmail.menu.slots.neoforge.NoItemCapSlot;
import dev.itsmeow.snailmail.menu.slots.neoforge.StampSlot;
import net.minecraft.core.BlockPos;
import net.minecraft.world.Container;
import net.neoforged.neoforge.items.IItemHandler;

public class EnvelopeMenuNeoForge extends EnvelopeMenu {

    private final IItemHandler items;

    public EnvelopeMenuNeoForge(int id, Container playerInventory, IItemHandler items) {
        this(id, playerInventory, items, BlockPos.ZERO, "", "");
    }

    public EnvelopeMenuNeoForge(int id, Container playerInventory, IItemHandler items, BlockPos returnPos, String toName, String fromName) {
