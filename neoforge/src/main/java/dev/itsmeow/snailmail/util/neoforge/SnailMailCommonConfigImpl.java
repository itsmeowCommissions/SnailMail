...
public class SnailMailCommonConfigImpl {
    ...
    public static class Configuration {
        ...
        public static ModConfigSpec initSpec() {
            final Pair<Configuration, ModConfigSpec> specPair = new ModConfigSpec.Builder().configure(Configuration::new);
            SPEC = specPair.getRight();
            INSTANCE = specPair.getLeft();
            return specPair.getRight();
        }

        public final ModConfigSpec .BooleanValue LOCK_BOXES;
        public final ModConfigSpec.BooleanValue PROTECT_BOX_DESTROY;
        public final ModConfigSpec.BooleanValue OP_BYPASS_LOCK;
        public final ModConfigSpec.IntValue BYPASS_LOCK_OP_LEVEL;

        protected Configuration(ModConfigSpec.Builder builder) {
