...
public class ModItems {
    private static final DeferredRegister<Item> ITEMS = DeferredRegister.create(SnailMail.MODID, Registry.ITEM_REGISTRY);
    ...
    public static RegistrySupplier<Item> STAMP = r("stamp", () -> new Item(new Item.Properties().tab(SnailMail.ITEM_GROUP)));
    ...
    protected static RegistrySupplier<BlockItem> rIB(RegistrySupplier<? extends Block> parent) {
        return ITEMS.register(parent.getId().getPath(), () -> new BlockItem(parent.get(), new Item.Properties().tab(SnailMail.ITEM_GROUP)));
    }
